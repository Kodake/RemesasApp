                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            ...
                            <li className={`nav-item ${location.pathname === '/tasas/agregar' ? 'active' : ''}`}>
                                <Link className="nav-link" to="/tasas/agregar">
                                    <svg fillRule="evenodd" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-currency-exchange" viewBox="0 0 16 16">
                            ...
                            <li className={`nav-item ${location.pathname === '/transacciones' ? 'active' : ''}`}>
                                <Link className="nav-link" to="/transacciones">
                                    <svg fillRule="evenodd" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-bank" viewBox="0 0 16 16">
