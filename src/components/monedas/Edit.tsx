        ...
        <div className="container">
            ...
            <form onSubmit={handleUpdateMoneda}>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="nombre" name="nombre" autoComplete='off' onChange={handleInputMoneda} value={store.moneda.nombre || ''} />
                </div>
                <div className="mb-3">
                    <label htmlFor='codigo' className="form-label">{'Código'}</label>
                    <input type="text" className="form-control" id="codigo" name="codigo" autoComplete='off' onChange={handleInputMoneda} value={store.moneda.codigo || ''} />
                </div>
