  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleUpdateTransaccion}>
        <div className="mb-3">
          <label htmlFor="clienteOrigen" className="form-label">
            {'Cliente Origen'}
          </label>
          <select
            ...
            value={store.transaccion.clienteOrigen}
            disabled
          >
        ...
        <div className="mb-3">
          <label htmlFor="clienteDestino" className="form-label">
            {'Cliente Destino'}
          </label>
          <select
            className="form-select"
            ...
            name="clienteDestino"
            onChange={handleInputCliente}
            value={store.transaccion.clienteDestino}
            disabled
          >
        ...
        <div className="mb-3">
          ...
          <select
            ...
            value={store.transaccion.moneda}
            disabled
          >
        ...
        <div className="mb-3">
          ...
          <input
            ...
            name="cantidad"
            autoComplete="off"
            onChange={handleInputTransaccion}
            value={store.transaccion.cantidad}
            disabled
          />
        </div>
        <div className="text-center">
          ...
          <Link
            ...
            onClick={handleClearTransaccion}
          >
            Regresar
          </Link>
        </div>
